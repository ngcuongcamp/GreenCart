const NewsLetter = () => {
    return (
        <div className="w-full flex items-center justify-center">
            <div className=" mt-20 w-full flex xl:flex-row lg:gap-10 flex-col   rounded-lg items-start md:items-center justify-between gap-5 text-sm max-w-5xl  p-8 bg-white">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    {/* 1st side */}
                    <div className="flex items-center justify-center w-full">
                        <div className="max-w-md w-full">
                            <h1 className="text-3xl font-semibold text-gray-700">Subscribe for fresh deals</h1>
                            <p className="text-gray-500 mt-2">
                                Get weekly updates on new arrivals, exclusive discounts, and tips on how to pick the freshest fruits and vegetables.
                            </p>
                            <div className="flex items-center gap-4 mt-10">
                                ...
                                />
                                <button className="bg-primary hover:bg-primary-dull transition-all px-6 py-2 rounded text-white font-medium">
                                    Subscribe
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="flex gap-10 items-center justify-center flex-col sm:flex-row">
                        <div className="space-y-4 md:max-w-48">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-base font-medium text-gray-800">Weekly updates</h3>
                            </div>
                            <p className="text-gray-500">
                                Be the first to hear about seasonal produce, recipes, and fresh arrivals straight from the farm.
                            </p>
                        </div>
                        ...
                        <div className="space-y-4 md:max-w-48">
                            ...
                            <p className="text-gray-500">
                                We only send relevant updates — no junk mail, no clutter. Just good food and good deals.
                            </p>
                        </div>
                    </div>
